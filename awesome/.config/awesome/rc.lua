...
globalkeys_map = {
    ...
    awful.key({altkey}, 'Right', function() lain.util.tag_view_nonempty(1) end,
              {description = 'view  previous nonempty', group = 'tag'}), -- Default client focus
    ...
    end, {description = 'go forth', group = 'client'}), -- Show/Hide Wibox
    ...
    end, {description = 'toggle wibox', group = 'awesome'}), -- On the fly useless gaps change
    awful.key({altkey, 'Control'}, '+',
              function() lain.util.useless_gaps_resize(1) end,
              {description = 'increment useless gaps', group = 'tag'}),
    awful.key({altkey, 'Control'}, '-',
              function() lain.util.useless_gaps_resize(-1) end,
              {description = 'decrement useless gaps', group = 'tag'}), -- Dynamic tagging
    ...
    awful.key({modkey}, 'z',
              ...
              {description = 'dropdown application', group = 'launcher'}), -- Widgets popups
    awful.key({altkey}, 'c',
    ...
    end, {description = 'show weather', group = 'widgets'}), -- Brightness
    ...
    end, {description = 'mpc on/off', group = 'widgets'}), -- Copy primary to clipboard (terminals to gtk)
    awful.key({modkey}, 'c',
    ...
    awful.key({modkey}, 'v',
              ...
              {description = 'copy gtk to terminal', group = 'hotkeys'}), -- User programs
    awful.key({modkey}, 'q', function() awful.spawn(browser) end,
              {description = 'run browser', group = 'launcher'}), -- Default
    awful.key({modkey}, 'r', function()
        os.execute(string.format(
                       'dmenu_run -i -fn \'Tamsyn\' -nb \'%s\' -nf \'%s\' -sb \'%s\' -sf \'%s\'',
...
globalkeys = gears.table.join(table.unpack(globalkeys_map))

clientkeys = gears.table.join(awful.key({altkey, 'Shift'}, 'm',
