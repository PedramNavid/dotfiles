...
screen.connect_signal('request::desktop_decoration', function(s)
  ...
  -- Create the wibox with a gradient background
  s.mywibox = awful.wibar {
    position = 'top',
    screen = s,
    bg = '#00000000', -- Transparent background for gradient
    height = dpi(24), -- Slightly taller bar
    widget = {
...
ruled.client.connect_signal('request::rules', function()
  ...
  -- Disable titlebars for all clients (no window decorations)
  ruled.client.append_rule {
    id = 'titlebars',
