...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ keys.modkey, "Control" }, "j", function()
		awful.screen.focus_relative(1)
	end, {
		description = "focus the next screen",
		group = "screen",
	}),
	awful.key({ keys.modkey, "Control" }, "k", function()
		awful.screen.focus_relative(-1)
	end, {
...
awful.keyboard.append_global_keybindings({
	awful.key({ keys.modkey, "Shift" }, "j", function()
		awful.client.swap.byidx(1)
	end, {
		description = "swap with next client by index",
		group = "client",
	}),
	awful.key({ keys.modkey, "Shift" }, "k", function()
		awful.client.swap.byidx(-1)
	end, {
