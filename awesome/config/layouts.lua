	...
	s.mywibox = awful.wibar({
		...
		widget = {
			...
			{ -- Right widgets
				...
				widgets.arrow("#343434", beautiful.colors.magenta),

				widgets.mpd_widget,
				widgets.arrow(beautiful.colors.magenta, beautiful.colors.yellow),

				widgets.mem_widget,
				widgets.arrow(beautiful.colors.yellow, beautiful.colors.purple),
